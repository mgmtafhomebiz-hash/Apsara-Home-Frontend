...
export const ACTION_CONFIG: Record<ActivityAction, { label: string; icon: string; bg: string; text: string }> = {
  ...
  purchase:            { label: 'Purchase',         icon: '🛒', bg: 'bg-teal-50',    text: 'text-teal-700'   },
  referral:            { label: 'Referral',         icon: '🔗', bg: 'bg-purple-50',  text: 'text-purple-700' },
  encashment_request:  { label: 'Encashment',       icon: '💸', bg: 'bg-amber-50',   text: 'text-amber-700'  },
  profile_update:      { label: 'Profile Update',   icon: '✏️',  bg: 'bg-indigo-50',  text: 'text-indigo-700' },
  kyc_submission:      { label: 'KYC Submission',   icon: '📄', bg: 'bg-orange-50',  text: 'text-orange-700' },
  password_change:     { label: 'Password Change',  icon: '🔒', bg: 'bg-rose-50',    text: 'text-rose-700'   },
  wallet_topup:        { label: 'Wallet Top-up',    icon: '💳', bg: 'bg-emerald-50', text: 'text-emerald-700'},
