    ...
    <div className="sticky top-0 z-[51] bg-gray-100 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-400 text-xs py-2 overflow-hidden">
      <div className="container mx-auto px-4 flex items-center">
        <div className="hidden md:flex items-center gap-5 shrink-0">
          <a href={`tel:${phone.replace(/\s+/g, '')}`} className="flex items-center gap-1.5 hover:text-orange-500 dark:hover:text-orange-400 transition-colors">
          ...
          <a href={`mailto:${email}`} className="flex items-center gap-1.5 hover:text-orange-500 dark:hover:text-orange-400 transition-colors">
