                ...
                <div data-error-field="referred_by" className="transition-transform duration-200">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-4 py-2.5 border rounded-xl text-sm placeholder-slate-300 focus:outline-none focus:ring-2 transition-all ${
                                lockReferralField
                                    ? 'bg-emerald-50 border-emerald-200 text-emerald-800 cursor-not-allowed focus:ring-emerald-100 focus:border-emerald-300'
                                    : errors.referred_by
                                        ? 'bg-slate-50 border-red-300 text-slate-700 focus:ring-red-200 focus:border-red-400'
                                        : 'bg-slate-50 border-slate-200 text-slate-700 focus:ring-orange-200 focus:border-orange-400'
                            }`}
                            required
                        />
                    </div>
