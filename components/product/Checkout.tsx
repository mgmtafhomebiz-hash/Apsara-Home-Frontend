    ...
    <div className="container mx-auto px-4 py-10">
      <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
          <p className="text-xs font-bold text-sky-500 uppercase">Test Checkout</p>
          ...
          <div className="mt-4 space-y-2 text-sm">
            ...
            <div className="flex justify-between font-bold text-sky-500"><span>Total</span><span>{'\u20b1'}{total.toLocaleString()}</span></div>
          </div>
        ...
        <div className="bg-slate-900 text-white rounded-2xl p-5">
          ...
          <Link href="/" className="inline-block mt-4 text-sm text-sky-300 hover:text-sky-200">
            Back to Home
          </Link>
        </div>
      </div>
