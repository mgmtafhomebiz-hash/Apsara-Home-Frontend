...
export const baseApi = createApi({
    reducerPath: 'api',
    baseQuery,
    tagTypes: ['User', 'Members', 'Products', 'Categories', 'Orders', 'Encashment', 'AdminUsers', 'AdminNotifications', 'CustomerNotifications', 'Wishlist', 'WebPages', 'Suppliers', 'InteriorRequests'],
    endpoints: () => ({}),
})
